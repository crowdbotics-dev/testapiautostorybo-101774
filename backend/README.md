...
## Project Structure
    ...
    ├── testapiautostorybo_101774  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_101774`
...
2. Clone this repo and `cd testapiautostorybo_101774`
